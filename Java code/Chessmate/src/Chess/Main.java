...
//		Image strip = getImage( getCodeBase(), "../images/alpha.gif" ); // applet stuff
		...
		Image strip = Toolkit.getDefaultToolkit().getImage( new String("C:/Users/swaroop/workspace/Chessmate/images/alpha.gif") );
...
*/
		toolbarImages[0] = Toolkit.getDefaultToolkit().getImage( new String( "C:/Users/swaroop/workspace/Chessmate/images/icon_new.gif" ) );
		toolbarImages[1] = Toolkit.getDefaultToolkit().getImage( new String( "C:/Users/swaroop/workspace/Chessmate/images/icon_loadgame.gif" ) );
		toolbarImages[2] = Toolkit.getDefaultToolkit().getImage( new String( "C:/Users/swaroop/workspace/Chessmate/images/icon_savegame.gif" ) );
		toolbarImages[3] = Toolkit.getDefaultToolkit().getImage( new String( "C:/Users/swaroop/workspace/Chessmate/images/icon_takeback.gif" ) );
		toolbarImages[4] = Toolkit.getDefaultToolkit().getImage( new String( "C:/Users/swaroop/workspace/Chessmate/images/icon_setupboard.gif" ) );
	toolbarImages[5] = Toolkit.getDefaultToolkit().getImage( new String( "C:/Users/swaroop/workspace/Chessmate/images/icon_help.gif" ) );
 ...
 */
	public Main()
	{
		...
		menu_Network.setEnabled(true);

		menu_Network_Host = new MenuItem("Host Game");
		menu_Network.add( menu_Network_Host );
		menu_Network_Host.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e){
